...
{
    /// <summary>
    /// Validates that a property has a number greater than a minimum value
    /// </summary>
    public class ValidateNumberIsGreaterThanAttribute : ValidationAttribute
    {
        ...
        public override IValidationMessage Validate(PropertyInfo property, IValidatable sender)
        {
            ...
            {
                result = ValidateIntegerValueIsGreaterThan(propertyValue, alternateProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Long)
            {
                result = ValidateLongValueIsGreaterThan(propertyValue, alternateProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Float)
            {
                result = ValidateFloatValueIsGreaterThan(propertyValue, alternateProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Double)
            {
                result = ValidateDoubleValueIsGreaterThan(propertyValue, alternateProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Decimal)
            {
                result = ValidateDecimalValueIsGreaterThan(propertyValue, alternateProperty, validationMessage);
            }
        ...
        private IValidationMessage ValidateShortValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = short.TryParse(GreaterThanValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateIntegerValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = int.TryParse(GreaterThanValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateLongValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = long.TryParse(GreaterThanValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateFloatValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = float.TryParse(GreaterThanValue, NumberStyles.Float, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateDoubleValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = double.TryParse(GreaterThanValue, NumberStyles.Number, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateDecimalValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = decimal.TryParse(GreaterThanValue, NumberStyles.Number, null, out convertedMinimumValue);
