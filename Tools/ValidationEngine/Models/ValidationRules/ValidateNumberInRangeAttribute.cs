...
namespace Tools.ValidationEngine.Models.ValidationRules
{
    ...
    public class ValidateNumberInRangeAttribute : ValidationAttribute
    {
        ...
        public override IValidationMessage Validate(PropertyInfo property, IValidatable sender)
        {
            ...
            if (!string.IsNullOrEmpty(MaximumComparisonProperty))
            {
                // Fetch the value of the secondary property specified.
                alternateMaxProperty = GetComparisonValue(sender, MaximumComparisonProperty);
            }

            if (!string.IsNullOrEmpty(MinimumComparisonProperty))
            {
                alternateMinProperty = GetComparisonValue(sender, MinimumComparisonProperty);
            }
            ...
            {
                result = ValidateIntegerInRange(propertyValue, alternateMaxProperty, alternateMinProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Long)
            {
                result = ValidateLongInRange(propertyValue, alternateMaxProperty, alternateMinProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Float)
            {
                result = ValidateFloatInRange(propertyValue, alternateMaxProperty, alternateMinProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Double)
            {
                result = ValidateDoubleInRange(propertyValue, alternateMaxProperty, alternateMinProperty, validationMessage);
            }
            else if (numberDataType == ValidationNumberDataTypes.Decimal)
            {
                result = ValidateDecimalInRange(propertyValue, alternateMaxProperty, alternateMinProperty, validationMessage);
            }
        ...
        private IValidationMessage ValidateShortValueInRange(object propertyValue, object alternateMaxProperty, object alternateMinProperty, IValidationMessage validationMessage)
        {
            ...
            bool maxValueConversionSucceeded = short.TryParse(MaximumValue, NumberStyles.Integer, null, out convertedMaximumValue);
            bool minValueConversionSucceeded = short.TryParse(MinimumValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateIntegerInRange(object propertyValue, object alternateMaxProperty, object alternateMinProperty, IValidationMessage validationMessage)
        {
            ...
            bool maxValueConversionSucceeded = int.TryParse(MaximumValue, NumberStyles.Integer, null, out convertedMaximumValue);
            bool minValueConversionSucceeded = int.TryParse(MinimumValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateLongInRange(object propertyValue, object alternateMaxProperty, object alternateMinProperty, IValidationMessage validationMessage)
        {
            ...
            bool maxValueConversionSucceeded = long.TryParse(MaximumValue, NumberStyles.Integer, null, out convertedMaximumValue);
            bool minValueConversionSucceeded = long.TryParse(MinimumValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateFloatInRange(object propertyValue, object alternateMaxProperty, object alternateMinProperty, IValidationMessage validationMessage)
        {
            ...
            bool maxValueConversionSucceeded = float.TryParse(MaximumValue, NumberStyles.Number, null, out convertedMaximumValue);
            bool minValueConversionSucceeded = float.TryParse(MinimumValue, NumberStyles.Number, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateDoubleInRange(object propertyValue, object alternateMaxProperty, object alternateMinProperty, IValidationMessage validationMessage)
        {
            ...
            bool maxValueConversionSucceeded = double.TryParse(MaximumValue, NumberStyles.Number, null, out convertedMaximumValue);
            bool minValueConversionSucceeded = double.TryParse(MinimumValue, NumberStyles.Number, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateDecimalInRange(object propertyValue, object alternateMaxProperty, object alternateMinProperty, IValidationMessage validationMessage)
        {
            ...
            bool maxValueConversionSucceeded = decimal.TryParse(MaximumValue, NumberStyles.Number, null, out convertedMaximumValue);
            bool minValueConversionSucceeded = decimal.TryParse(MinimumValue, NumberStyles.Number, null, out convertedMinimumValue);
