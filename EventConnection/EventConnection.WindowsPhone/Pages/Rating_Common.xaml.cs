...
namespace EventConnection.Pages
{
    ...
    /// </summary>
    public sealed partial class Rating_Common : VisualStateAwarePage
    {
        private ViewModels.Context.Rating_Common _vm;

        public Rating_Common()
        {
            InitializeComponent();

            _vm = (ViewModels.Context.Rating_Common) DataContext;
        }
